...
namespace FiapCloudGames.Application.Services
{
    public class GameService : IGameService
    {
        ...
        {
            using var activity = this.StartApiActivity($"{nameof(GameService)}.GetallAsync");
        ...
        {
            using var activity = this.StartApiActivity($"{nameof(GameService)}.GetByIdAsync");
        ...
        {
            using var activity = this.StartApiActivity($"{nameof(GameService)}.CreateAsync");
